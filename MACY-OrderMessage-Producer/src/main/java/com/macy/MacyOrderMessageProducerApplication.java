...
public class MacyOrderMessageProducerApplication {
	...
	private ApiInfo getApiInfo() {
		return new ApiInfo("MACY-Order-Producer REST API Documentation", 
				"MACY-Order-Producer REST APIs released by Zensar Ltd.",
				"1.0",
	...
	public Docket getCustomizeDocket() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.paths(PathSelectors.ant("/macy/producer/**"))
				.build();
	}
}
